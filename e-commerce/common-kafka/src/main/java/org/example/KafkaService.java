...
public class KafkaService<T> implements Closeable {
    ...
    public KafkaService(String topic, ConsumerFunction<T> parse, String simpleName, Class<T> type,Map<String,String> configPro) {
        this(parse,simpleName,type,configPro);
        this.consumer.subscribe(Collections.singletonList(topic));
        this.run();
    }
    public KafkaService(Pattern topic, ConsumerFunction<T> parse, String simpleName, Class<T> type, Map<String,String> configPro) {
        this(parse,simpleName,type,configPro);
